...
USE CATALOG `uc-demo-tpch`;

CREATE SHARE IF NOT EXISTS uc_tpch_share;
...
ALTER SHARE uc_tpch_share ADD TABLE tpch.region;
ALTER SHARE uc_tpch_share ADD TABLE external_loc.country;
...
--ALTER SHARE gsethi_uc_tpch_share ADD TABLE quickstart_database.quickstart_table
...
SHOW ALL IN SHARE uc_tpch_share

-- COMMAND ----------

-- View metadata of a specific share
DESCRIBE SHARE uc_tpch_share
...
CREATE RECIPIENT IF NOT EXISTS uc_tpch_share_recipient COMMENT "Intended recipient for of Delta Share"
...
DESCRIBE RECIPIENT uc_tpch_share_recipient
...
-- MAGIC %md
-- MAGIC You can also DROP Recipient with `DROP RECEIPIENT` command.
...
Grant SELECT ON SHARE uc_tpch_share TO RECIPIENT uc_tpch_share_recipient
...
SHOW GRANT TO RECIPIENT uc_tpch_share_recipient
...
SHOW GRANT ON SHARE uc_tpch_share
...
-- MAGIC %md
-- MAGIC ##DELETE RECEIPT AND SHARE##

-- COMMAND ----------

--- You can also drop a recipient
DROP RECIPIENT uc_tpch_share_recipient;
DROP SHARE uc_tpch_share;
