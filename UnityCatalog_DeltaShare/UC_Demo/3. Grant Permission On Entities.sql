...
GRANT SELECT ON TABLE $CatalogName.$SchemaName.f_lineitem_restricted TO $AmeaUserGroup;
GRANT SELECT ON TABLE $CatalogName.$SchemaName.d_customer_restricted TO $AmeaUserGroup;
GRANT SELECT ON TABLE $CatalogName.$SchemaName.d_order_restricted TO $AmeaUserGroup;
GRANT SELECT ON TABLE $CatalogName.$SchemaName.d_part TO $AmeaUserGroup;
GRANT SELECT ON TABLE $CatalogName.$SchemaName.d_supplier TO $AmeaUserGroup;


-- COMMAND ----------

GRANT SELECT ON TABLE $CatalogName.$SchemaName.f_lineitem_restricted TO $EmeaUserGroup;
GRANT SELECT ON TABLE $CatalogName.$SchemaName.d_customer_restricted TO $EmeaUserGroup;
GRANT SELECT ON TABLE $CatalogName.$SchemaName.d_order_restricted TO $EmeaUserGroup;
GRANT SELECT ON TABLE $CatalogName.$SchemaName.d_part TO $EmeaUserGroup;
GRANT SELECT ON TABLE $CatalogName.$SchemaName.d_supplier TO $EmeaUserGroup;
...
SHOW GRANTS ON TABLE $CatalogName.$SchemaName.d_supplier;
