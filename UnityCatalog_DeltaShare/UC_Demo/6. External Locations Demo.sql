...
-- MAGIC %md
-- MAGIC # EXTERNAL LOCATION Can Only Be Created From Databricks SQL GUI or Query Window
-- MAGIC 
...
-- MAGIC 
-- MAGIC ## Run CMD3 From Databricks SQL Query Window
...
-- MAGIC 
-- MAGIC CREATE EXTERNAL LOCATION `uc_demo_ext_tables` URL 's3://databricks-gsethi' WITH STORAGE CREDENTIAL 'e2-uc-passrole`; 
