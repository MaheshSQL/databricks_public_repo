...
-- MAGIC   print(f"Optimizing {tableName}")
...
insert into tableOptimizations select "PART" , "P_PARTKEY" ;
...
ALTER TABLE REGION
ADD COLUMN TEAM_OWNER STRING 
COMMENT 'Team that owns this region'
...
CREATE VIEW vw_FACT_LINEITEM AS
SELECT
*
