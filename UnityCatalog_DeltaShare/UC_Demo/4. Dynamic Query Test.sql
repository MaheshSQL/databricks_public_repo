...
DESCRIBE TABLE EXTENDED d_customer_restricted
...
SELECT * FROM f_lineitem_restricted

-- COMMAND ----------

select distinct TEAM_OWNER from f_lineitem_restricted
...
SELECT * FROM d_customer_restricted

-- COMMAND ----------

SELECT * FROM d_order_restricted
