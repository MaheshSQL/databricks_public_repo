...
# MAGIC 
# MAGIC val connectionString = "Endpoint=sb://gsethi-ehub-learning.servicebus.windows.net/;SharedAccessKeyName=default;SharedAccessKey=N0Xyf8Fk+SdbJXNsT40gxtl2GkIC/vk6t4AifQddH/8=;EntityPath=gsethi_ehub_1"
# MAGIC 
